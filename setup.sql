ALTER USER DGOH SET DEFAULT_SECONDARY_ROLES = ('ALL');
...
ALTER SCHEMA FAR_TRANS_DB.RAW SET LOG_LEVEL = 'INFO';
ALTER SCHEMA FAR_TRANS_DB.RAW SET TRACE_LEVEL = 'ALWAYS';
ALTER SCHEMA FAR_TRANS_DB.RAW SET METRIC_LEVEL = 'ALL';

ALTER SCHEMA FAR_TRANS_DB.PUBLIC SET LOG_LEVEL = 'INFO';
ALTER SCHEMA FAR_TRANS_DB.PUBLIC SET TRACE_LEVEL = 'ALWAYS';
ALTER SCHEMA FAR_TRANS_DB.PUBLIC SET METRIC_LEVEL = 'ALL';
...
GRANT USAGE ON SCHEMA PUBLIC TO ROLE FAR_TRANS_DBT_ROLE;
...
GRANT CREATE TABLE, CREATE VIEW ON SCHEMA PUBLIC TO ROLE FAR_TRANS_DBT_ROLE;
GRANT CREATE TABLE, CREATE VIEW ON SCHEMA RAW TO ROLE FAR_TRANS_DBT_ROLE;
...
GRANT ALL PRIVILEGES ON SCHEMA PUBLIC TO ROLE FAR_TRANS_DBT_ROLE;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON FUTURE TABLES IN SCHEMA PUBLIC TO ROLE FAR_TRANS_DBT_ROLE;
GRANT SELECT, INSERT, UPDATE, DELETE ON FUTURE TABLES IN SCHEMA RAW TO ROLE FAR_TRANS_DBT_ROLE;
...
EXECUTE dbt project DBT_PROJECT_INVESTMENT_V2 args='run --target prod';